...
export default function Sidebar() {
  ...
  const isActive = (path: string) => {
    // Jika path root "/", cek apakah pathname persis "/"
    if (path === "/") return pathname === "/";
    // Untuk path lain, cek apakah pathname diawali string tersebut
    return pathname.startsWith(path);
  };

  return (
    <aside className="w-64 min-h-screen bg-white border-r border-gray-200 flex-shrink-0 flex flex-col font-sans print:hidden sticky top-0 h-screen z-50">
...
const UserIcon = () => <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>;
